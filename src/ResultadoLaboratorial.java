public class ResultadosLaboratoriais {
    ...
    public String verificadorDeResultadosTriglicérides(){
        float resultados;
            ...
            if (resultados < 150){
                ...
                if ( resultados <= 199){
                    ...
                    if (!(resultados == 200) && (resultados <= 499)) {
                        return "Nível de Triglicérides está alto";
                    }else{
                        return "Nível de Triglicérides está muito alto";
                    }
                }
            ...
            if (resultado <= 0) {
                ...
                if (resultado < 200){
                    ...
                    if (!(resultado == 200) && (resultado <=239)) {
                        return "Nível de Colesterol tota limítrofe";
                    }else{
